...
QUnit.test('Testing the showInput function with 3 set of values', function (assert) {
    assert.equal(showInput("This is a statement"), 19, "Works fine");
    assert.equal(showInput("I don't know about this one"), 27, "Works fine too");
    assert.equal(showInput(""), 0, "Works with null values");
});
